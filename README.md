...
- 🏥 Where I'm aiming, not where I am: medical imaging, computer vision, and data science. Starting the Medical AI micro-degree this coming semester — the draw is access to Ajou University Hospital's clinical infrastructure, which is the part that's hard to replicate elsewhere. Nothing shipped in that direction yet
...
| 2026 – | **Ajou University** | Dept. of Software — Software & Computer Engineering major |
| 2026 – | **Ajou University** | Medical AI micro-degree — coursework starts this semester, in progress |
